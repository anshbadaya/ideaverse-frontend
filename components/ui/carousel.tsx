    ...
    return (
      <CarouselContext.Provider
        value={{
          ...
          scrollPrev,
          scrollNext,
          canScrollPrev: externalCanGoPrev !== undefined ? externalCanGoPrev : canScrollPrev,
          canScrollNext: externalCanGoNext !== undefined ? externalCanGoNext : canScrollNext,
          opts,
          orientation,
          plugins,
          setApi,
